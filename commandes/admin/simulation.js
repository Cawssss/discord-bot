...
module.exports.run = async(bot, message, args) => {
    ...
    let Embed = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Start ')
        .setDescription(` **Bienvenue ${message.author} , dans la simulation du bot Caws** `)
    ...
    let Embed2 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Explication ')
    ...
    let Embed3 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Aide Commandes #1 ')
    ...
    let Embed4 = new Discord.MessageEmbed()
        .setTitle('<:enveloppe:800390849320976425> Simulation Caws - Notificatitions')
    ...
    let Embed5 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Aide Commandes #2 ')
    ...
    let Embed6 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Aide Commandes #3')
    ...
    let Embed62 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Des Serveurs')
    ...
    let Embed7 = new Discord.MessageEmbed()
        .setTitle('Simulation Caws - Satisfait ?')
        ...
        .addField('https://discord.com/api/oauth2/authorize?client_id=952353988156751903&permissions=8&scope=bot', 'Ou effectue la commande `+qrcode`')
...
module.exports.help = {
    ...
    description: "⚡・Permet de mettre en place le système de simulation guidée.",
  };
