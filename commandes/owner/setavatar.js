...
module.exports.run = (client, message, args) => {
    ...
    message.attachments.forEach(attachment => {
        ...
        .then(u => message.channel.send(`\`${getNow().time}\` :white_check_mark: ${message.author}, Vous venez de changer la photo de profil de votre bot.`))
        ...
        message.channel.send(`\`${getNow().time}\` :x: ${message.author}, Vous n'avez fourni aucune valeur, veuillez mettre soit une image soit un lien`);
    }
};
