...
module.exports.run = async (client, message, args) => {
   ...
   .addField("`🔊` Format du compteur des membres en vocal :", db.membercounter.vocalformat.replace(`<count>`, message.guild.members.cache.filter(m => m.voice.channel).size), true)
